...
import { Toolbar, type GridColDef, type GridRowModel, type GridColumnVisibilityModel } from '@mui/x-data-grid'

import FilterPanel, { type FilterGroup } from './FilterPanel'
import { GridDensity, type GridDensityType, DENSITY_STORAGE_KEY } from './gridHelpers'
        ...
        >
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        inputProps={{
                          'data-test-id': `users-columns-menu-checkbox-${col.field}`,
                        }}
                      />
                    }
          ...
          >
            {DENSITY_OPTIONS.map(option => (
              ...
              >
                <ListItemIcon>
                  {density === option.value ? <CheckIcon fontSize="small" /> : null}
                </ListItemIcon>
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                size="small"
                inputProps={{ 'data-test-id': 'users-toolbar-include-deleted-checkbox' }}
              />
            }
