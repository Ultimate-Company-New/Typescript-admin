    ...
    <>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              ...
              <BodyText data-test-id="user-view-first-name" className={styles['user-details-view__value']}>
                {firstName || '—'}
              </BodyText>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              ...
              <BodyText data-test-id="user-view-last-name" className={styles['user-details-view__value']}>
                {lastName || '—'}
              </BodyText>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              <FieldLabel>Login Name (Email)</FieldLabel>
              <BodyText data-test-id="user-view-login-name" className={styles['user-details-view__value']}>
                {loginName || '—'}
              </BodyText>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              ...
              <BodyText data-test-id="user-view-phone" className={styles['user-details-view__value']}>
                {formatPhone(phone)}
              </BodyText>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              ...
              <BodyText data-test-id="user-view-role" className={styles['user-details-view__value']}>
                {role || '—'}
              </BodyText>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Box className={styles['user-details-view__field']}>
              ...
              <BodyText data-test-id="user-view-dob" className={styles['user-details-view__value']}>
                {formatDate(dob)}
              </BodyText>
            </Box>
          </Grid>
      ...
      <Paper className={styles['add-users-page__section']}>
        ...
        <Box className={commonStyles['view-notes__container']}>
          <BodyText data-test-id="user-view-notes" className={commonStyles['view-notes__text']}>
            {notes?.trim() ? notes : '—'}
          </BodyText>
        </Box>
      </Paper>
