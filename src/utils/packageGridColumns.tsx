  ...
  return [
    ...
    },
    {
      ...
      valueGetter: (value, row: any) => {
        const length = row.length || row._package?.length || 0
        const breadth = row.breadth || row.width || row._package?.breadth || 0
        const height = row.height || row._package?.height || 0
    ...
    },
    {
      ...
      headerAlign: 'left',
      valueGetter: (value, row: any) => {
        return row.packageName || row._package?.packageName || '—'
      },
    },
    {
      field: 'packageType',
      ...
      headerAlign: 'center',
      valueGetter: (value, row: any) => {
        return row.packageType || row._package?.packageType || ''
      },
