  ...
  return [
    ...
    },
    {
      ...
      valueGetter: (value, row: any) => {
        return row.addressNickName || row.pickupLocation?.addressNickName || ''
      },
    ...
    },
    {
      ...
      headerAlign: 'left',
      valueGetter: (value, row: any) => {
        return row.address?.nameOnAddress || row.nameOnAddress || ''
      },
      renderCell: (params: GridRenderCellParams) => (
        <Box sx={{ display: 'flex', alignItems: 'center', height: '100%' }}>
          <RenderLongCellItem
    ...
    },
    {
      ...
      headerAlign: 'left',
      valueGetter: (value, row: any) => {
        return row.address?.emailOnAddress || row.emailOnAddress || '—'
      },
      renderCell: (params: GridRenderCellParams) => (
        <Box sx={{ display: 'flex', alignItems: 'center', height: '100%' }}>
          <RenderLongCellItem
    ...
    },
    {
      ...
      headerAlign: 'left',
      valueGetter: (value, row: any) => {
        return row.shipRocketPickupLocationId || row.pickupLocation?.shipRocketPickupLocationId || '—'
      },
      renderCell: (params: GridRenderCellParams) => (
        <Box sx={{ display: 'flex', alignItems: 'center', height: '100%' }}>
          {params.value}
